...
or operator retention policy. It is now historical evidence; see the [prepared
v1.0.1 release manifest](../releases/v1.0.1.md) for the next source-release
criteria and the [v1.0.0 manifest](../releases/v1.0.0.md) for the historical
predecessor scope.

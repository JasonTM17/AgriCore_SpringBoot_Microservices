...
@Testcontainers
class NotificationOutboxRetryPostgresMigrationTest {

    @Container
    private static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("agricore_notification_outbox_migration")
    ...
    void migrationCreatesUsableRetryAndQuarantineQueues() throws Exception {
        ...
        try (Connection connection = POSTGRES.createConnection("")) {
            ...
            assertValidIndex(connection, "idx_notification_outbox_retry_queue",
                    "published_at IS NULL", "quarantined_at IS NULL");
            assertValidIndex(connection, "idx_notification_outbox_quarantine",
            ...
            assertThat(queuePlan(connection)).contains("idx_notification_outbox_retry_queue");
        }

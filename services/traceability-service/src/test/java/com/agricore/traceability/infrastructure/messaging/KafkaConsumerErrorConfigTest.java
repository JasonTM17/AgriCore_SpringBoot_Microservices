...
class KafkaConsumerErrorConfigTest {
    ...
    void metersOnlyDltDestinationsOnTheRetryTopicRecoverer() {
        ...
        AtomicReference<TopicPartition> destination = new AtomicReference<>(
                new TopicPartition("agricore.harvest.events-retry-1000", 3)
        );
        ...
        destination.set(new TopicPartition("agricore.harvest.events.DLT", 3));
        ...
        assertThat(dltRecord.partition()).isEqualTo(3);

...
public class GlobalExceptionHandler {
    ...
    /**
     * A losing race on a unique index is the caller's conflict, not a server fault. Customer codes,
     * order numbers, and the one-saga-per-order index are all checked before insert, but a check is
     * not a lock: two requests can both pass it and the database rejects the second.
     *

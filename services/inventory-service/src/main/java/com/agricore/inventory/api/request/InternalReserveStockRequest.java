...
public record InternalReserveStockRequest(
        @NotNull UUID farmId,
    ...
    public ReserveStockRequest toReserveStockRequest() {
        return new ReserveStockRequest(inventoryItemId, quantity, referenceType, referenceId);
    }
}

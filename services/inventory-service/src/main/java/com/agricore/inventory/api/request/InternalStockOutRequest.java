...
public record InternalStockOutRequest(
        @NotNull UUID farmId,
    ...
    public StockOutRequest toStockOutRequest() {
        return new StockOutRequest(inventoryItemId, quantity, referenceType, referenceId, note);
    }
}

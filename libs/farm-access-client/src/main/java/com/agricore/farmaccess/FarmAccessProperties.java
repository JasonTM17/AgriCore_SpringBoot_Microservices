...
@ConfigurationProperties("agricore.farm-access")
public class FarmAccessProperties {
    ...
    URI validatedBaseUri() {
        ...
        try {
            ...
            throw invalid("base-url must be a valid absolute URI", ex);
        }
        ...
        try {
            ...
            throw invalid("base-url could not be normalized", ex);
        }
    }
    ...
    private static IllegalArgumentException invalid(String message) {
        return new IllegalArgumentException("Invalid agricore.farm-access configuration: " + message);
    }

    private static IllegalArgumentException invalid(String message, Throwable cause) {
        return new IllegalArgumentException("Invalid agricore.farm-access configuration: " + message, cause);
    }
}
